         ...
         <div class="row">
             <div class="col-lg-12">
                 ...
                 <div class="alert alert-danger alert-dismissible fade show">
                     <form action="../backend/deleteProductController.php?id=<?php echo $_GET["id"]; ?>" method="POST">
                         <h4 class="alert-heading">Delete Product</h4>
                         <p>Are you sure deleting this record? </p>
                         <hr>
                         <div class="text-center">
                             <button type="submit" class="btn btn-danger">Delete</button>
                             <a href="viewProduct.php"><button type="button" class="btn btn-secondary">Cancel</button></a>
