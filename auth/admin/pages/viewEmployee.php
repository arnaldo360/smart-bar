         ...
         <div class="col-12">
             ...
             <div class="card recent-sales overflow-auto">
                 ...
                 <div class="card-body table-responsive">
                     ...
                     <h5 class="card-title">View Bar Employees</h5>

                     <?php
                        require_once("../../../database/dbConnect.php");

                        $sql = "SELECT * FROM employee JOIN bar ON bar.barId = employee.employeeBar";
                        ...
                        while ($row = mysqli_fetch_array($results)) {
                            ...
                            echo "</td>
                                 <td>
                                     <a href='displayEmployee.php?id=" . $row["employeeID"] . "'><button type='button' class='btn btn-info' id='$count'><i class='bi bi-eye'></i></button></a>
                                     ...
                                     <a href='deleteEmployee.php?id=" . $row["employeeID"] . "'><button type='button' class='btn btn-danger' id='modalDelete.$count.'><i class='bi bi-trash'></i></button></a>
                                 </td>
                             </tr>";
                            $count = $count + 1;
                        }
