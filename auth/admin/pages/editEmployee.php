                     ...
                     <div class="card-body pt-3">
                         ...
                         <div class="tab-content pt-2">
                             ...
                             <div class="tab-pane fade fade show active profile-edit pt-3" id="profile-edit">
                                 ...
                                 <!-- Profile Edit Form -->
                                 <form class="row g-3 needs-validation" action="../backend/editEmployeeController.php?id= <?php echo $_GET['id']; ?>" method="POST" novalidate>
                                     ...
                                     <div class="row mb-3">
                                         ...
                                         <div class="col-md-8 col-lg-9">
                                             <input name="mobile" type="text" class="form-control <?php echo (!empty($mobile_err)) ? 'is-invalid' : ''; ?>" id="Phone" value="<?php echo $employeeContact; ?>">
                                     ...
                                     <div class="row mb-3">
                                         ...
                                         <div class="col-md-8 col-lg-9">
                                             <input name="email" type="email" class="form-control <?php echo (!empty($email_err)) ? 'is-invalid' : ''; ?>" id="Email" value="<?php echo $employeeEmail; ?>">
                                     ...
                                     <div class="row mb-3">
                                         ...
                                         <div class="col-md-8 col-lg-9">
                                             <input name="dateOfBirth" type="date" class="form-control <?php echo (!empty($date_err)) ? 'is-invalid' : ''; ?>" id="date" value="<?php echo $employeeEmail; ?>">
                                     ...
                                     <div class="row mb-3">
                                         ...
                                         <div class="col-md-8 col-lg-9">
                                             <input name="address" type="text" class="form-control <?php echo (!empty($address_err)) ? 'is-invalid' : ''; ?>" id="Adreess" value="<?php echo $employeeEmail; ?>">
                                     ...
                                     <div class="row mb-3">
                                         ...
                                         <div class="col-md-8 col-lg-9">
                                             <select name="title" class="form-control <?php echo (!empty($gender_err)) ? 'is-invalid' : ''; ?>" id="Gender" value="<?php echo $employeeGender; ?>">
                                     ...
                                     <div class="text-center">
                                         ...
                                         <a href="viewEmployee.php"><button type="button" class="btn btn-danger">Cancle</button></a>
                                     </div>
